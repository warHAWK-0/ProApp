...
class ComplaintCard extends StatelessWidget {
  ...
  ComplaintCard({Key key, this.complaint,this.uid}) : super(key: key);
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Spacer(),
              Text(datefor(),style: complaintCardSubHeading,)
              ],
            ),
            SizedBox(height: 10,),
            Divider(thickness: 1,)
  ...
  String datefor(){
    ...
    if (!localDateTime.difference(justNow).isNegative) {
      ...
      else{return complaint.start.toString().substring(11,16);}
    }
